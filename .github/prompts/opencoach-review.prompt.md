...
version: 2.0
description: 用户指定目标，根据提供的工作流，引导用户对当前周期内已创建的小目标进行复盘和评估
requires_agent: true
workflow_file: workflows/create-review.md
...
- 工作流文件：必须成功读取`@opencoach/workflows/create-review.md`
...
<workflow_reference>
- 工作流文件：`@opencoach/workflows/create-review.md`
